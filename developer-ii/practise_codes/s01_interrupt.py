...
#   บอร์ดนี้ "รองรับ" machine.Timer (hardware timer) แล้ว — เรียก Timer ได้จริง
#   (Eva Game มี timer id 0-2 ให้ใช้) ตรงกับสไลด์ session-01
#   แต่แล็บนี้เราตั้งใจฝึก "software timer" เป็นพื้นฐานก่อน: ใช้ time.ticks_ms()
#   เทียบเวลาเองในลูปแบบไม่บล็อก — ได้ผลเหมือนกระพริบเป็นจังหวะ และเข้าใจหลักการ
#   จับเวลาด้วยมือก่อน ค่อยต่อยอดไป machine.Timer ทีหลัง
